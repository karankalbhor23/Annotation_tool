...
st.set_page_config(page_title="Image Description Generator", page_icon="📝", layout="centered")
...
st.markdown("<div class='title'>Image Description Generator📝</div>", unsafe_allow_html=True)
st.markdown("<div class='subtitle'>Upload an image and get a detailed description</div>", unsafe_allow_html=True)
...
if uploaded_image is not None:
    ...
    # Message prompt for model input
    messages = [
...
Output Guidelines:
Length: Between 25-300 words in a single, grammatically correct paragraph.
